...
const NOT_CONFIGURED =
  "Rabbit LINE Pay driver not configured — see src/lib/payments/README.md for what a real implementation needs";

/** Skeleton implementing `PaymentDriver` — every method throws until filled
 * in. See README.md alongside this file for Rabbit LINE Pay's actual API
 * docs and what each method needs to do, using omise-driver.ts as the
 * worked example. */
export class RabbitLinePayDriver implements PaymentDriver {
